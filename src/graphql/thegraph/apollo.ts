...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  ...
  [SupportedChainId.BOMB]: 'https://graph.bombchain.com/subgraphs/name/bombswap/uniswap-v3',
...
const httpLink = new HttpLink({ uri: CHAIN_SUBGRAPH_URL[SupportedChainId.BOMB] })
